...
#define DAY_OF_WEEK_ARRAY               "\x00\xBE\x6F\xBD\x65\xE3\x65\xBB\xC4\xBD\xB8\xBA\x00\xB3\xBF\x6F\x70\xBD\xB8\xBA\x00\x63\x70\x65\xE3\x61\x00\xC0\x65\xBF\xB3\x65\x70\xB4\x00\xBE\xC7\xBF\xBD\xB8\xE5\x61\x00\x63\x79\xB2\xB2\x6F\xBF\x61\x00\xB3\x6F\x63\xBA\x70\x65\x63\x65\xBD\xC4\x65"
...
extern PROGMEM const char version_string[];

extern PROGMEM const char empty_string[];
extern PROGMEM const char no_time_string[];
extern PROGMEM const char trip_string[];
extern PROGMEM const char on_off_array[];
extern PROGMEM const char time_correction_string[];
extern PROGMEM const char reset_string[];

#ifdef MIN_MAX_VOLTAGES_SUPPORT
extern PROGMEM const char voltage_string[];
#endif

#ifdef CONTINUOUS_DATA_SUPPORT
extern PROGMEM const char continuous_data_string[];
#endif

#ifdef EXTENDED_ACCELERATION_MEASUREMENT
extern PROGMEM const char accel_meas_array[];
extern PROGMEM const char accel_meas_timing_string[];
#else
extern PROGMEM const char accel_meas_string[];
#endif

extern PROGMEM const char accel_meas_wait_string[];
extern PROGMEM const char timeout_string[];

#ifdef SERVICE_COUNTERS_CHECKS_SUPPORT
extern PROGMEM const char warning_string[];
#endif

extern PROGMEM const char config_menu_title_string[];
extern PROGMEM const char config_menu_array[];
extern PROGMEM const char service_counters_array[];

extern PROGMEM const char settings_bits_array[];

#ifdef TEMPERATURE_SUPPORT
extern PROGMEM const char temp_sensors_array[];
#ifdef DS18B20_CONFIG_EXT
extern PROGMEM const char temp_no_sensors[];
extern PROGMEM const char temp_sensor_string[];
#endif
#endif

extern PROGMEM const char day_of_week_array[];
extern PROGMEM const char month_array[];

#ifdef JOURNAL_SUPPORT
extern PROGMEM const char journal_viewer_string[];
extern PROGMEM const char journal_viewer_items_array[];
extern PROGMEM const char journal_viewer_no_items_string[];
#endif
